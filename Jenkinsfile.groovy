pipeline {
  ...
  stages {
    stage('Clone Repo') {
      steps {
        git url: 'https://github.com/GitCosmicray/BACKEND-HELM.git', branch: 'main'
      }
    }
      ...
      steps {
        withCredentials([string(credentialsId: 'PAT-access-github', variable: 'TOKEN')]) {
          sh '''
            ...
            git push https://$TOKEN@github.com/GitCosmicray/BACKEND-HELM.git main
          '''
        }
      }
    }
